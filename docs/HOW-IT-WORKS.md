...
- **The engine is pure TypeScript with no React**, driven by a catalog of data tables, unit-tested (27 test files under `src/game/__tests__`, 54 across the repo) and paced by a simulator that the tests assert against.
