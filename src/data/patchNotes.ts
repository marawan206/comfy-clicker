...
export const PATCH_NOTES: readonly PatchNote[] = [
  {
    ...
    changes: [
      ...
      { kind: 'added', text: 'Combos pay. Keep clicks under 400 ms apart and from the tenth every click pays 1.25 times, from the 25th 1.5, from the 50th double, from the 100th triple. The pill shows the multiplier, a tier-up bursts and flashes, and two achievements sit at 50 and 100' },
