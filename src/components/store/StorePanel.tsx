...
export function StorePanel() {
  ...
  return (
    // `data-tour` sits on a wrapper because `Panel` takes no pass-through props. It is the
    // tour's fallback anchor for "buy something" while nothing in the store is affordable yet
    // and no row carries `store-buy`.
    <div data-tour="store" className="flex h-full min-h-0 flex-col">
